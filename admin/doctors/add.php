...
<head>
    ...
    <title>Add Doctors | Auto Pharmacy CPanel</title>
                    ...
                    <form id="save_data" method="POST" action="javascript:add_data(`save_data`);" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" id="doc_name" placeholder="Doctor Name..." class="form-control" name="doc_name" autofocus="" oninput="this.classList.remove(`is-invalid`);" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                ...
                                <input type="text" id="job_title" placeholder="Job Title..." class="form-control" name="job_title" oninput="this.classList.remove(`is-invalid`);" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
                                <label for="fb_link" class="form-control-label">Facbook Username</label>
                                <input type="text" id="fb_link" placeholder="Facbook Username..." class="form-control" name="fb_link" oninput="this.classList.remove(`is-invalid`);" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
                                <label for="insta_link" class="form-control-label">Instagram Username</label>
                                <input type="text" id="insta_link" placeholder="Instagram Username..." class="form-control" name="insta_link" oninput="this.classList.remove(`is-invalid`);" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
                                <label for="x_link" class="form-control-label">X Username</label>
                                <input type="text" id="x_link" placeholder="X Username..." class="form-control" name="x_link" oninput="this.classList.remove(`is-invalid`);" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
                                <label for="wp_link" class="form-control-label">Whatsapp Number</label>
                                <input type="tel" id="wp_link" placeholder="Whatsapp Number..." class="form-control" name="wp_link" oninput="this.classList.remove(`is-invalid`);" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
