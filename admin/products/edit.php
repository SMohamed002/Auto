...
<head>
    ...
    <title>Edit Product | Auto Pharmacy CPanel</title>
                    ...
                    <form id="save_data" method="POST" action="javascript:edit_data(`save_data`,<?php echo $id; ?>);" enctype="multipart/form-data">
                            ...
                            <div class="col-12">
                                ...
                                <select class="form-select" id="cat_id" name="cat_id" autofocus="" onchange="this.classList.remove(`is-invalid`);" required">
                                    ...
                                    if (!empty($cats) && is_countable($cats) && count($cats) > 0) {
                                        foreach ($cats as $cat) {
                                            echo '<option value="' . $cat['id'] . '" '.($cat['id'] == $data[0]['cat_id'] ? 'selected' : '').'>' . $cat['name'] . '</option>';
                                        }
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                ...
                                <input value="<?php echo $data[0]['name']; ?>" type="text" id="p_name" placeholder="Product Name..." class="form-control" name="p_name" oninput="this.classList.remove(`is-invalid`);" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
                                <label for="actv_ing" class="form-control-label">Active Ingredient</label>
                                <input value="<?php echo $data[0]['actv_ing']; ?>" type="text" id="actv_ing" placeholder="Active Ingredient..." class="form-control" name="actv_ing" oninput="this.classList.remove(`is-invalid`);" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
                                <label for="dose" class="form-control-label">Dose</label>
                                <input value="<?php echo $data[0]['dose']; ?>" type="text" id="dose" placeholder="Dose..." class="form-control" name="dose" oninput="this.classList.remove(`is-invalid`);" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
                                <label for="p_desc" class="form-control-label">Product Description</label>
                                <textarea name="p_desc" id="p_desc" rows="3" placeholder="Product Description..." class="form-control" oninput="this.classList.remove(`is-invalid`);"><?php echo $data[0]['p_desc']; ?></textarea>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
                                <label for="price" class="form-control-label">Price <span class="text-danger">*</span></label>
                                <input value="<?php echo $data[0]['price']; ?>" type="number" step="any" min="0" id="price" placeholder="Price..." class="form-control" name="price" oninput="this.classList.remove(`is-invalid`);" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
                                <label for="qty" class="form-control-label">Quantity <span class="text-danger">*</span></label>
                                <input value="<?php echo $data[0]['qty']; ?>" type="number" step="any" min="0" id="qty" placeholder="Quantity..." class="form-control" name="qty" oninput="this.classList.remove(`is-invalid`);" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
