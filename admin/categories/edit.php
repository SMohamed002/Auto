                    ...
                    <form id="save_data" method="POST" action="javascript:edit_data(`save_data`,<?php echo $id; ?>);" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input value="<?php echo $data[0]['name'] ?>" type="text" id="cat_name" placeholder="Category Name..." class="form-control" name="cat_name" autofocus="" oninput="this.classList.remove(`is-invalid`);" />
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
